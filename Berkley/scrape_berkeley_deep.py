"""
STARS deep scraper v2 — authenticated
=====================================
...
────────────────────────────────────────────────────────────────────────
 ...
 2. Log in in your normal browser, then open any credit page, e.g.
    https://reports.aashe.org/institutions/university-of-california-berkeley-ca/report/2025-02-19/OP/energy-climate/OP-6/
 ...
 6. Run:
      python scrape_berkeley_deep_v2.py
...
SCORECARD_CACHE = pathlib.Path("berkeley_scorecard.html")
CREDIT_CACHE_DIR = pathlib.Path("cache_credits")
OUT_TXT = pathlib.Path("berkeley_credits.txt")
OUT_CSV = pathlib.Path("berkeley_qa.csv")
REPORT_TAG = "/report/2025-02-19/"
...
def main():
    if not SCORECARD_CACHE.exists():
        print("[error] run scrape_berkeley.py first to create the scorecard cache.")
        return
