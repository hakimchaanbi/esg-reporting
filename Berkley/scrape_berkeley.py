"""
STARS scraper — UC Berkeley proof of concept
=============================================
...
REPORT_URL = (
    "https://reports.aashe.org/institutions/"
    "university-of-california-berkeley-ca/report/2025-02-19/"
)
CACHE_FILE = pathlib.Path("berkeley_scorecard.html")
OUTPUT_CSV = pathlib.Path("berkeley_stars.csv")
...
def category_from_url(href: str):
    ...
    e.g. '.../report/2025-02-19/OP/energy-climate/OP-6/'  ->  ('OP', 'OP-6')
    """
