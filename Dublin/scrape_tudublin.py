"""
STARS scraper — Technological University Dublin
=============================================
...
REPORT_URL = "https://reports.aashe.org/institutions/technological-university-dublin-dublin/report/2024-12-02/"
CACHE_FILE = pathlib.Path("tudublin_scorecard.html")
OUTPUT_CSV = pathlib.Path("tudublin_stars.csv")
...
def category_from_url(href: str):
    ...
    e.g. '.../report/2024-12-02/OP/energy-climate/OP-6/'  ->  ('OP', 'OP-6')
    """
