"""
STARS deep scraper v2 — University College Cork (authenticated)
=====================================
...
────────────────────────────────────────────────────────────────────────
 ...
 2. Log in in your normal browser, then open any credit page, e.g.
    https://reports.aashe.org/institutions/university-college-cork-national-university-of-ireland-cork-co-corcaigh/report/2026-03-05/OP/energy-climate/OP-6/
...
SCORECARD_CACHE = pathlib.Path("cork_scorecard.html")
CREDIT_CACHE_DIR = pathlib.Path("cache_credits_cork")
OUT_TXT = pathlib.Path("cork_credits.txt")
OUT_CSV = pathlib.Path("cork_qa.csv")
REPORT_TAG = "/report/2026-03-05/"
...
def main():
    if not SCORECARD_CACHE.exists():
        print("[error] run scrape_cork.py first to create the scorecard cache.")
        return
